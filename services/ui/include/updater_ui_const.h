...
constexpr const char *UPDATERMODE_SECUREERASE = "secure_erase";
constexpr const char *UPDATERMODE_UPLOADLOG = "uploadLog";
constexpr const char *UPDATERMODE_DISKERASE = "disk_erase";
