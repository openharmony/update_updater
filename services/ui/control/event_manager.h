...
#ifndef UPDATER_UX_EVENT_MANAGE_H
#define UPDATER_UX_EVENT_MANAGE_H
...
namespace Updater {
class UxEventManage final {
    DISALLOW_COPY_MOVE(UxEventManage);
public:
    UxEventManage();
    ~UxEventManage() = default;
    static UxEventManage &GetInstance();
