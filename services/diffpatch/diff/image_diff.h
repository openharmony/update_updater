...
protected:
    ...
    void UpdateBlocks(const BlockBuffer &orgNewBuffer, const FileInfo *newFileInfo, const BlockBuffer &orgOldBuffer,
        const FileInfo *oldFileInfo, std::pair<std::vector<uint8_t>, std::vector<uint8_t>> &buffer);
