...
#define PATCH_LOGE(format, ...) Logger(Updater::ERROR, (__UPDATER_FILE_NAME__), (__LINE__), format, ##__VA_ARGS__)
#define PATCH_DEBUG(format, ...) Logger(Updater::DEBUG, (__UPDATER_FILE_NAME__), (__LINE__), format, ##__VA_ARGS__)
#define PATCH_LOGI(format, ...) Logger(Updater::INFO, (__UPDATER_FILE_NAME__), (__LINE__), format, ##__VA_ARGS__)
#define PATCH_LOGW(format, ...) Logger(Updater::WARNING, (__UPDATER_FILE_NAME__), (__LINE__), format, ##__VA_ARGS__)
