...
constexpr off_t PARTITION_RECORD_OFFSET = MISC_PARTITION_RECORD_OFFSET;
constexpr off_t PARTITION_UPDATER_RECORD_SIZE = MISC_PARTITION_RECORD_SIZE;
constexpr off_t PARTITION_RECORD_OFFSET_SIZE = 16;
constexpr off_t PARTITION_UPDATER_RECORD_MSG_SIZE = PARTITION_UPDATER_RECORD_SIZE - PARTITION_RECORD_OFFSET_SIZE;
constexpr off_t PARTITION_RECORD_START = MISC_PARTITION_RECORD_OFFSET + PARTITION_RECORD_OFFSET_SIZE;
