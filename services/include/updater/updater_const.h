...
constexpr const char *UPDATER_INODE_PATH = "/data/updater/inode";
...
constexpr const char *CDC_LOG_NAME = "cdc_log";
...
constexpr const char *DEV_SD_MODE = "UPDATE:SDFROMDEV";
constexpr const char *UPDATE_MAINIMG = "UPDATE:MAINIMG";
constexpr const char *FACTORY_SD_UPDATE = "factory_sd_update";
constexpr const char *UPDATE_SD = "UPDATE:SD";
constexpr const char *OTA_INTRAL_MODE = "ota_intral_update";
