...
#define PKG_LOGE(format, ...) Logger(Updater::ERROR, (__UPDATER_LOG_FILE_NAME__), (__LINE__), format, ##__VA_ARGS__)
#define PKG_LOGI(format, ...) Logger(Updater::INFO, (__UPDATER_LOG_FILE_NAME__), (__LINE__), format, ##__VA_ARGS__)
#define PKG_LOGW(format, ...) Logger(Updater::WARNING, (__UPDATER_LOG_FILE_NAME__), (__LINE__), format, ##__VA_ARGS__)
