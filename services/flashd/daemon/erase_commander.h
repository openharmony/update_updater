...
#ifndef FLASHD_ERASE_COMMANDER_H
#define FLASHD_ERASE_COMMANDER_H

#include "commander.h"

namespace Flashd {
class EraseCommander : public Commander {
public:
    explicit EraseCommander(callbackFun callback) : Commander(callback) {};
